...
- Current measured `: any`: 661 after typing the level serializer, VS Code language/workspace/window APIs, extension host runtime, chat surface, unified SDK, AI tools registry, DAP, LSP, and debug integration boundaries.
