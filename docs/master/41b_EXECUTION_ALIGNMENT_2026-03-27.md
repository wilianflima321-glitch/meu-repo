...
> **Nota de indexação:** ficheiro `41b_EXECUTION_ALIGNMENT_2026-03-27.md` — registo de **alinhamento técnico aplicado**; a colisão histórica foi resolvida com os prefixos `41a_` e `41b_`. Ver `DEPRECATED_INDEX.md`.
