...
- `cloud-web-app/web/components/terminal/XTerminal.tsx` segue como barrel de `11` linhas; `BaseXTerminal.tsx` agora e apenas uma shell de `99` linhas, enquanto a densidade real do terminal passou para `cloud-web-app/web/components/terminal/useTerminalRuntime.ts` (`150`), apoiada por `useTerminalTransport.ts` (`145`), `useTerminalSessions.ts` (`120`), `terminalSessionApi.ts` (`71`), `terminalSessionConnection.ts` (`61`), `useTerminalSelection.ts` (`64`), `useTerminalShortcuts.ts` (`51`), `useTerminalViewport.ts` (`66`), `useTerminalOptions.ts` (`58`), `useTerminalImperativeHandle.ts` (`51`) e `MultiTerminalPanel.tsx` (`70`).
- Colaboracao:
