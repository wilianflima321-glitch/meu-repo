...
- `: any` in app code: `505` -> still a major strictness gap, reduced by the 2026-05-02 runtime/workspace/window/extension/chat/sdk/tools, DAP/LSP, debug-adapter, SWR, and API integration typing passes.
