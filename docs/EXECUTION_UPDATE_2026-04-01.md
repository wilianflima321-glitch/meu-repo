...
**Aviso de escopo:** o conteúdo abaixo foi fornecido pelo solicitante e **não foi validado nesta execução**. Deve ser tratado como **baseline de planejamento** até nova checagem com evidência no repositório e/ou testes reais.

**Análise comparativa completa:** UX, Acessibilidade, Performance e Recursos.
