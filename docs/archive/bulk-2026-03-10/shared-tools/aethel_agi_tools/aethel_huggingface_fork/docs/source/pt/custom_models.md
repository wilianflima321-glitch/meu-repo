...
A menos que exigido por lei aplicável ou acordado por escrito, o software distribuído sob a Licença é distribuído em
uma BASE "COMO ESTÁ", SEM GARANTIAS OU CONDIÇÕES DE QUALQUER TIPO, expressas ou implícitas. Consulte a Licença para
obter as permissões e limitações específicas que regem o uso.

⚠️ Observe que este arquivo está em Markdown, mas contém sintaxe específica para nosso construtor de documentos (semelhante ao MDX) que pode não ser
renderizado corretamente em seu visualizador de Markdown. -->
