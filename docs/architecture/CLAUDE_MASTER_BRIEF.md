...
**Mode:** Planning **closed**; implementation starts only on explicit **"Execute Wave N"** / Master Map round.  
...
**Copy-paste to start Block 6:**

```
Execute Block 6 from docs/architecture/AETHEL_CLAUDE_EXECUTION_MASTER_MAP.md (rounds 6A→6H).
Read: AETHEL_PLANS_CANONICAL_REFERENCE.md v1.1 §10, AETHEL_PAYG_AND_WALLET_SPEC.md v1.1,
implementation_plan.md, contracts_planning.md, billing_security_analysis.md.
Ship Cursor-class Usage UX (meters, spend caps, composer chip, calm 402). One mega-PR series.
npm run qa:enterprise-gate PASS before and after.
```
...
| **Ultra (200×)** | Wallet/BYOK | Wallet/BYOK | Wallet/BYOK | Wallet/BYOK | Wallet/BYOK | Wallet/BYOK |
