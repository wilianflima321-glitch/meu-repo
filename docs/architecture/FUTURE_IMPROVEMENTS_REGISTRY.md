...
| `IMPROVE-AI-004` | IA integradora USD (não gera malha) | ai | C | `DEBT-SEARCH-002` | I70 | **→ Onda J.7 CORE (PARTIAL)** | Prompt → library placement via `usd-integrator.ts`; no Tripo-only AAA; **USDZ browser preview PARTIAL** (Three USDZLoader); USDA/USD/USDC + OpenUSD stage **HELD** |
