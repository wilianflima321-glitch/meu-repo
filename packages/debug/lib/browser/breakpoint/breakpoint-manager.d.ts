...
export declare class BreakpointManager extends MarkerManager<SourceBreakpoint> {
    ...
    readonly onDidChangeBreakpoints: import("@theia/core/common/event").Event<SourceBreakpointsChangeEvent>;
    protected readonly onDidChangeFunctionBreakpointsEmitter: Emitter<FunctionBreakpointsChangeEvent>;
    readonly onDidChangeFunctionBreakpoints: import("@theia/core/common/event").Event<FunctionBreakpointsChangeEvent>;
    protected readonly onDidChangeInstructionBreakpointsEmitter: Emitter<InstructionBreakpointsChangeEvent>;
    readonly onDidChangeInstructionBreakpoints: import("@theia/core/common/event").Event<InstructionBreakpointsChangeEvent>;
