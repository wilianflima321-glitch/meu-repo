// Campos de Deformação Neural (NDF) - A Morte dos Esqueletos
// O Barro não tem ossos rígidos. O volume muscular expande quando dobrado.

pub struct NeuralDeformationFieldsNdf;
