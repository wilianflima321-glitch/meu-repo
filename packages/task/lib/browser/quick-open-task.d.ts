...
export declare class TaskRunQuickOpenItem implements QuickPickItem {
    ...
    readonly buttons?: Array<QuickInputButton> | undefined;
    constructor(token: number, task: TaskConfiguration, taskService: TaskService, isMulti: boolean, taskDefinitionRegistry: TaskDefinitionRegistry, taskNameResolver: TaskNameResolver, taskSourceResolver: TaskSourceResolver, taskConfigurationManager: TaskConfigurationManager, buttons?: Array<QuickInputButton> | undefined);
    get label(): string;
