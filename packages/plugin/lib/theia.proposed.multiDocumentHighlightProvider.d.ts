declare module '@theia/plugin' {
    ...
    namespace languages {
         ...
         * @stubbed
         */
        function registerMultiDocumentHighlightProvider(selector: DocumentSelector, provider: MultiDocumentHighlightProvider): Disposable;
    }
}
//# sourceMappingURL=theia.proposed.multiDocumentHighlightProvider.d.ts.map