...
- expanded shared limiter + scanner coverage to analytics/experiments, feature management, notifications/onboarding/quotas, templates, and task helper endpoints
