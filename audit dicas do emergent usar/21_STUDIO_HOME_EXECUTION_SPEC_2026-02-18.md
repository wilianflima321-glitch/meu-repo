...
28. Architecture gate oversized-module threshold was tightened to `oversizedFiles <= 47` to freeze current monolith debt ceiling.
...
36. Cutscene type contracts were split into `cutscene-types.ts`, reducing oversized debt baseline and tightening limit to `oversizedFiles <= 47`.
