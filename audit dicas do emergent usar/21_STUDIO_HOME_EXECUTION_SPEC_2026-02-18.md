...
28. Architecture gate oversized-module threshold was tightened to `oversizedFiles <= 46` to freeze current monolith debt ceiling.
...
37. Capture photo filter presets were split into `capture-presets.ts`, reducing oversized debt baseline and tightening limit to `oversizedFiles <= 46`.
