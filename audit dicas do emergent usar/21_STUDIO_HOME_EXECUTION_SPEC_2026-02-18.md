...
28. Architecture gate oversized-module threshold was tightened to `oversizedFiles <= 45` to freeze current monolith debt ceiling.
...
38. Skeletal animation contracts were split into `skeletal-animation-types.ts`, reducing oversized debt baseline and tightening limit to `oversizedFiles <= 45`.
