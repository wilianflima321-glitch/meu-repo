...
10. Critical rate-limit scanner now also includes billing lifecycle, wallet, usage status, admin payments/security endpoints, project lifecycle/export surfaces, and asset upload/download/mutation surfaces.
