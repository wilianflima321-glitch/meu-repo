...
## ✅ Ações imediatas de organização

1) **Arquivar duplicados**: marque documentos anteriores ou redundantes como “histórico” e referencie apenas os canônicos acima em novos materiais.  
2) **Links consistentes**: ao criar novos guias, linke sempre o documento canônico correspondente (ex.: visão executiva → `SUMARIO_EXECUTIVO_2025-11-27.md`).  
3) **Sem protótipos/demos**: garanta que novos anexos sigam o padrão final (sem rascunhos parciais).  
4) **Interface sem lacunas**: ao atualizar páginas da IDE, sincronize navegação e componentes com `ANALISE_ESTRUTURA_INTERFACE_2025-11-27.md` para evitar páginas órfãs.
