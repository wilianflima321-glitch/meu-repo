...
fn to_report(r: SvoDepthLodSoakReport, note: impl Into<String>) -> KernelSvoDepthLodWireReport {
    KernelSvoDepthLodWireReport {
        ...
        distinct_from_hybrid_geometry_svo_probe: r.distinct_from_hybrid_geometry_svo_probe,
        distinct_from_velocity_buffer_ecs_probe: r.distinct_from_velocity_buffer_ecs_probe,
        distinct_from_sdf_motion_vector_buffer_probe: r
            .distinct_from_sdf_motion_vector_buffer_probe,
        distinct_from_sdf_octree_hashing_probe: r.distinct_from_sdf_octree_hashing_probe,
