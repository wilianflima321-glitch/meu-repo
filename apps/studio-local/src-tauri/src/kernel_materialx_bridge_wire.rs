...
use aethel_kernel_rust::materialx_bridge::{MaterialXBridge, MaterialXParseError};
...
/// Ingests a raw MTLX XML payload and applies it to a mock SceneGraph (for validation/desktop bridge).
#[tauri::command]
...
/// Exports a mock entity's PBR data to an MTLX string.
#[tauri::command]
