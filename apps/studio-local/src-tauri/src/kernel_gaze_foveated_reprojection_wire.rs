...
fn to_report(
    ...
    KernelGazeFoveatedReprojectionWireReport {
        ...
        distinct_from_strain_aware_texturing_probe: r.distinct_from_strain_aware_texturing_probe,
        distinct_from_msl_wgsl_compiler_probe: r.distinct_from_msl_wgsl_compiler_probe,
