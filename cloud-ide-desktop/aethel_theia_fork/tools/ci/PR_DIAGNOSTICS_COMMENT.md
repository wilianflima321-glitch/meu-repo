...
- Playwright: `npx playwright test --config=playwright.config.ts --reporter=html` (report generated in `playwright-report/`)
...
2. Run Playwright: `npx playwright test --config=playwright.config.ts --reporter=html`
