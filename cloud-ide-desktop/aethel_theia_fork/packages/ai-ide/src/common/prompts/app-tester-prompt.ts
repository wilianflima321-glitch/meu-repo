...
export const APP_TESTER_PROMPT_ID = 'app-tester-v1';
export const APP_TESTER_PROMPT_VERSION = '1.0.0';

export const appTesterSystemPrompt = `You are an automated testing agent for an IDE.
...
export const appTesterPromptTemplate = {
    id: APP_TESTER_PROMPT_ID,
    version: APP_TESTER_PROMPT_VERSION,
    template: appTesterSystemPrompt,
    checksum: ''
};
