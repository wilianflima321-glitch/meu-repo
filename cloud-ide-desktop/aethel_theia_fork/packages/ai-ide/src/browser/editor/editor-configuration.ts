 ...
 */
export function getMonacoOptions(config: EditorConfiguration): any {
    return {
        // LSP Features
        hover: {
 ...
 */
export function getShortcut(action: keyof typeof EDITOR_SHORTCUTS): string {
    const platform = getPlatform();
    return EDITOR_SHORTCUTS[action][platform];
}
