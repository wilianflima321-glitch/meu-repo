...
export const TYPESCRIPT_SNIPPETS: Record<string, Snippet> = {
    'class': {
        prefix: 'class',
        body: [
            'class ${1:ClassName} {',
...
export const JAVASCRIPT_SNIPPETS: Record<string, Snippet> = {
    'log': {
        prefix: 'log',
...
export const HTML_SNIPPETS: Record<string, Snippet> = {
    'html5': {
        prefix: '!',
        body: [
            '<!DOCTYPE html>',
...
export const CSS_SNIPPETS: Record<string, Snippet> = {
    'flex': {
        prefix: 'flex',
        body: [
            'display: flex;',
 ...
 */
export function getSnippetsForLanguage(languageId: string): Record<string, Snippet> {
    switch (languageId) {
        case 'typescript':
        case 'typescriptreact':
            return { ...JAVASCRIPT_SNIPPETS, ...TYPESCRIPT_SNIPPETS };
        case 'javascript':
 ...
 */
export function registerSnippets(monaco: any): void {
