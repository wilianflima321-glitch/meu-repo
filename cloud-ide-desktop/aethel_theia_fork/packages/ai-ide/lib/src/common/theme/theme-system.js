...
// THEME SYSTEM
// ============================================================================
let ThemeSystem = class ThemeSystem {
    constructor() {
        // Themes
        this.themes = new Map();
        this.iconThemes = new Map();
        this.fontThemes = new Map();
        // Layouts
    ...
    getIconForFile(filename) {
        ...
        // Default
        return this.currentIconTheme.definitions.get(this.currentIconTheme.defaultFileIcon);
    }
    getIconForFolder(foldername, expanded = false) {
        if (!this.currentIconTheme)
            return undefined;
...
exports.ThemeSystem = ThemeSystem = __decorate([
