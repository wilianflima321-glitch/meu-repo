...
exports.ToolchainRegistry = void 0;
const inversify_1 = require("inversify");
/**
 * Toolchain registry with domain-specific configurations
 */
let ToolchainRegistry = class ToolchainRegistry {
    constructor() {
        this.tools = new Map();
    ...
    getToolsForDomain(domain) {
        return Array.from(this.tools.values()).filter(t => t.domain === domain || t.domain === 'shared');
    }
    /**
     * Validate tool execution
     */
    async validateExecution(toolId, params) {
...
exports.ToolchainRegistry = ToolchainRegistry;
exports.ToolchainRegistry = ToolchainRegistry = __decorate([
