...
exports.PhysicsSubsystem = void 0;
const inversify_1 = require("inversify");
let PhysicsSubsystem = class PhysicsSubsystem {
    constructor() {
        this.name = 'PhysicsSubsystem';
        this.priority = 'core';
    ...
    // BODY MANAGEMENT
    // ========================================================================
    createBody(entityId, definition) {
        const body = {
            entityId,
    ...
    applyForce(entityId, force) {
        ...
        if (!body || body.type === 'static')
            return;
        // F = ma, so a = F/m
        const acceleration = force.map(f => f / body.mass);
        body.linearVelocity = [
...
exports.PhysicsSubsystem = PhysicsSubsystem;
exports.PhysicsSubsystem = PhysicsSubsystem = __decorate([
