...
export declare class AIToolsConfigurationWidget extends ReactWidget {
    ...
    private _confirmationManager?;
    protected set confirmationManager(v: ToolConfirmationManager);
    protected get confirmationManager(): ToolConfirmationManager;
    ...
    private _toolInvocationRegistry?;
    protected set toolInvocationRegistry(v: ToolInvocationRegistry);
    protected get toolInvocationRegistry(): ToolInvocationRegistry;
