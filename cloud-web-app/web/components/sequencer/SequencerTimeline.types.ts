// Shared timeline contracts for the cinematic sequencer surface.
...
export interface TimelineTrack {
  ...
  name: string;
  type: TrackType;
  targetId: string; // Scene object ID
  property: string; // Example: 'position.x', 'rotation', 'intensity'
...
export interface SequencerTimelineProps {
  ...
  onTrackAdd: (
    groupId: string,
    track: Omit<TimelineTrack, "id" | "keyframes">,
  ) => void;
