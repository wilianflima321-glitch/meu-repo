...
function FoliageInstances3D({ instancias, types, windTime }: FoliageInstances3DProps) {
...
function FoliageTypeCard({ type, isSelecionared, onSelecionar, instanceCount }: FoliageTypeCardProps) {
