/**
 * Sound cue graph model and node catalog.
 * Kept outside TSX so the editor shell stays smaller and design-token audits
 * do not confuse graph palette data with component styling.
 */
// ============================================================================
// TYPES
// ============================================================================
