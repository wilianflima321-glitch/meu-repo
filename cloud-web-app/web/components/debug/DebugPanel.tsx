  ...
  return (
    <div className="h-full flex flex-col bg-[var(--aethel-surface-primary)] text-[var(--aethel-text-primary)]">
      ...
      <div className="flex items-center gap-1 p-2 border-b border-[var(--aethel-border-primary)]">
        <button type="button" aria-label={status === 'paused' ? 'Continuar execução' : 'Pausar execução'}
        ...
        <button type="button" aria-label="Parar depuração"
          onClick={handleStop}
          className="p-1.5 hover:bg-[var(--aethel-border-primary)] rounded transition-colors"
          title="Stop (Shift+F5)"
          disabled={status === 'stopped'}
        ...
        <button type="button" aria-label="Reiniciar depuração"
        ...
        <button type="button" aria-label="Executar passo sobre"
        ...
        <button type="button" aria-label="Executar passo para dentro"
        ...
        <button type="button" aria-label="Executar passo para fora"
          ...
          {activeTab === 'watch' && (
            ...
            >
              <div className="flex gap-2 mb-2">
                ...
                />
                <button type="button" aria-label="Adicionar expressão observada"
                  onClick={addWatch}
              ...
              {watchResults.map((watch, i) => (
                ...
                >
                  ...
                  <button type="button" aria-label={`Remover expressão observada ${watch.expression}`}
