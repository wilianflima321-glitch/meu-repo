...
export const defaultSettings: SettingCategory[] = [
  {
    id: 'project',
    name: 'Project',
    icon: 'PROJECT',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        name: 'Lighting',
        settings: [
          { id: 'global_illumination', name: 'Global Illumination', description: 'GI method (web preview: baked/SSR only — advanced paths [HELD])', type: 'enum', value: 'Baked', options: [
            { label: 'None', value: 'None' },
            { label: 'Baked', value: 'Baked' },
            { label: 'Screen Space [HELD]', value: 'SSGI' },
            { label: 'Advanced GI [HELD]', value: 'AdvancedHeld' },
          ]},
    ...
    sections: [
      {
        ...
        settings: [
          ...
          { id: 'win_raytracing', name: 'Ray Tracing [HELD]', description: 'Hardware RT path not shipped — do not enable as live', type: 'boolean', value: false },
        ],
      },
      {
        id: 'linux',
