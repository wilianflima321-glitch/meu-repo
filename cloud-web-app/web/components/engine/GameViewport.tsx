...
import type { GameViewportProps } from '@/lib/engine/GameViewport.runtime';

const RuntimeGameViewport = dynamic(() => import('@/lib/engine/GameViewport.runtime'), {
  ssr: false,
  loading: () => (
...
export type { GameViewportProps } from '@/lib/engine/GameViewport.runtime';
