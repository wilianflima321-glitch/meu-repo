...
export default function Settings() {
  ...
  return (
    <div className="aethel-panel aethel-flex h-full">
      {/* Sidebar */}
      <div className="aethel-sidebar w-64 border-r border-[var(--aethel-border-secondary)]">
                  ...
                  <div>
                    ...
                    <div className="aethel-flex aethel-items-center aethel-gap-4">
                      <input
                        ...
                        className="flex-1"
                      />
                      <span className="text-sm font-mono bg-[var(--aethel-surface-quaternary)] px-2 py-1 rounded min-w-[3rem] text-center">
                  ...
                  <div>
                    ...
                    <div className="aethel-flex aethel-items-center aethel-gap-3">
                      <input
                        ...
                        className="w-4 h-4 text-sky-600 bg-[var(--aethel-surface-quaternary)] border-[var(--aethel-border-secondary)] rounded focus:ring-sky-500"
                      />
            ...
            <div className="space-y-6">
              <div className="aethel-card">
                ...
                <div className="text-center py-8">
                  <div className="w-16 h-16 bg-[var(--aethel-surface-quaternary)] rounded-full aethel-flex aethel-items-center aethel-justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-[var(--aethel-text-tertiary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4" />
                    </svg>
                  </div>
                  <h4 className="text-lg font-medium text-[var(--aethel-text-secondary)] mb-2">Extension Marketplace</h4>
                  <p className="text-[var(--aethel-text-tertiary)]">Browse and install extensions to enhance Aethel IDE</p>
                  ...
                  <div>
                    ...
                    <div className="aethel-flex aethel-items-center aethel-gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[var(--aethel-text-tertiary)]">Help improve Aethel by sharing crash reports and feature usage</p>
                      </div>
                    </div>
                  </div>
                </div>
