    ...
    <div className="aethel-p-6 space-y-6">
      <div className="aethel-card aethel-p-6">
        <div className="aethel-flex aethel-items-center aethel-justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Admin Studio</p>
            <h2 className="mt-2 text-2xl font-semibold text-slate-100">Painel administrativo</h2>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 aethel-gap-6">
            <div className="aethel-card aethel-p-6">
              <div className="aethel-flex aethel-items-center aethel-justify-between">
                <div>
                  <h3 className="text-sm font-medium text-slate-400">Total de Usuarios</h3>
            ...
            <div className="aethel-card aethel-p-6">
              <div className="aethel-flex aethel-items-center aethel-justify-between">
                <div>
                  <h3 className="text-sm font-medium text-slate-400">Total de Creditos</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 aethel-gap-6">
            <div className="aethel-card aethel-p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-400 mb-2">E-mail do Usuario</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-400 mb-2">Creditos a Adicionar</label>
                  <input
                    type="number"
                    className="aethel-input"
                    placeholder="1000"
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 aethel-gap-6">
            <div className="aethel-card aethel-p-6">
              ...
              <div className="space-y-3">
                <div className="aethel-flex aethel-justify-between">
                  <span className="text-sm text-slate-400">Starter ($19)</span>
                  <span className="font-semibold">$15,200</span>
                </div>
                <div className="aethel-flex aethel-justify-between">
                  <span className="text-sm text-slate-400">Pro ($49)</span>
                  <span className="font-semibold">$21,600</span>
                </div>
                <div className="aethel-flex aethel-justify-between">
                  <span className="text-sm text-slate-400">Studio ($99)</span>
            ...
            <div className="aethel-card aethel-p-6">
              ...
              <div className="space-y-3">
                <div className="aethel-flex aethel-justify-between">
                  <span className="text-sm text-slate-400">Cartao de credito</span>
            ...
            <div className="aethel-card aethel-p-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-slate-400">Taxa de falha este mes</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 aethel-gap-6">
            ...
            <div className="aethel-card aethel-p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="aethel-flex aethel-justify-between aethel-items-center">
                  <span className="text-sm text-slate-400">Uso de Memoria</span>
                  <span className="font-semibold">67%</span>
                </div>
                <div className="aethel-flex aethel-justify-between aethel-items-center">
                  <span className="text-sm text-slate-400">Conexoes Ativas</span>
                  <span className="font-semibold">1,247</span>
                </div>
                <div className="aethel-flex aethel-justify-between aethel-items-center">
