...
type AgentWindowTabsProps = {
  activeView: 'fleet' | 'navigation' | 'replay' | 'evolution'
  setActiveView: (view: 'fleet' | 'navigation' | 'replay' | 'evolution') => void
  focusClass: string
}
...
const views = [
  ...
  { id: 'evolution' as const, label: 'Evolution', hint: 'Founder inbox' },
]
