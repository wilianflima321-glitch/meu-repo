  ...
  return (
    <div style={{ padding: '12px', background: 'var(--aethel-surface-primary)', borderRadius: '8px' }}>
      ...
      <div style={{ display: 'flex', gap: '8px' }}>
        ...
        <button type="button" aria-label="Add new animation parameter"
      ...
      >
        ...
        <div style={{ marginBottom: '16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            ...
            <button type="button" aria-label="Add transition condition"
...
export { edgeTypes, nodeTypes } from './AnimationBlueprintEditorNodes';
