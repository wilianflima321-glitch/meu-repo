    ...
    <div className="flex flex-wrap items-center justify-end gap-2">
      ...
      {onOpenIde && (
        <button
          type="button"
          onClick={onOpenIde}
          className="inline-flex items-center gap-2 rounded-2xl bg-[linear-gradient(135deg,var(--aethel-accent),var(--aethel-info))] px-4 py-2 text-xs font-semibold text-[var(--aethel-text-primary)] shadow-[0_14px_32px_color-mix(in_srgb,var(--aethel-info)_24%,transparent)] transition hover:brightness-110"
        >
