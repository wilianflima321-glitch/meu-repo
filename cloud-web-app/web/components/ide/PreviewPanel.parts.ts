...
(() => {
  ...
  function setArmed(next) {
    ...
    if (armed && !styleNode) {
      ...
      styleNode.textContent = 'html[data-aethel-inspect-armed="true"] *{cursor:crosshair!important}html[data-aethel-inspect-armed="true"] *:hover{outline:1px solid #60a5fa!important;outline-offset:2px!important}';
