...
export function AssetBrowser3D({ assets = defaultAssets, onAssetSelect, onAssetDrag }: AssetBrowserProps) {
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium text-[var(--aethel-text-primary)] truncate">{asset.name}</p>
                    <p className="text-xs text-[var(--aethel-text-tertiary)]">{asset.type}</p>
                  </div>
                  {asset.favorite && (
 ...
 : 'text-[var(--aethel-text-secondary)] hover:bg-[color-mix(in_srgb,var(--aethel-surface-tertiary)_50%,transparent)]'
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[var(--aethel-text-tertiary)]">{asset.category} • {asset.size || 'N/A'}</p>
                </div>
                {asset.favorite && (
...
export { AssetBrowser3D as AssetBrowser }
