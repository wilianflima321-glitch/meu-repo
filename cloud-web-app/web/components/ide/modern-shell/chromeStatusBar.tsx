...
import { Code2, Columns, Crosshair, FolderTree, GitBranch, Sparkles, TerminalSquare, Users } from 'lucide-react'

import type { Diagnostic as MonacoDiagnostic } from '@/components/editor/MonacoEditorPro'
import type { EditorCursorStatus, EditorSelectionStatus } from '@/components/ide/fullscreen/types'
