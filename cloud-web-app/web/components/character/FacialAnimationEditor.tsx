...
import { BLEND_SHAPE_CATEGORIES, EMOTION_PRESETS, FACS_ACTION_UNITS, VISEMES, type BlendShapeValues, type EmotionPreset, type LipSyncKeyframe } from './facial-animation-model'
