...
import { generateHairStrands, rgbToHex } from './hair-fur-model';
import type { BrushSettings, BrushTool, ClumpingSettings, CurlSettings, GradientStop, HairRegion, LODSettings, PhysicsSettings } from './hair-fur-model';
