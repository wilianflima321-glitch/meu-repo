...
import { CheckCircle2, ClipboardList, Code2, DollarSign, Radio, SearchCheck } from 'lucide-react'
        ...
        <div className="flex flex-wrap items-center gap-2">
          {latestEvidence ? (
            ...
            >
              ...
              {latestEvidence.kind === 'trace' ? 'Trace pronta' : 'Research pronta'}
          ...
          >
            ...
            Run estimate {formatUsd(currentRunEstimate)}
          </button>
        </div>
      </div>
    </section>
