...
const ConnectedModelPreview = dynamic(() => import('./ConnectedModelPreview'), {
  ssr: false,
  loading: () => (
    <div style={{ color: 'var(--aethel-text-tertiary)', fontSize: '13px' }}>
          ...
          <div style={{ flex: 1, minHeight: 0, background: 'var(--aethel-surface-tertiary)', borderRadius: '8px', padding: '12px' }}>
            ...
            {!isLoading && !error && isModelAsset(asset) && (
              <div style={{ width: '100%', height: '100%' }}>
                <ConnectedModelPreview url={previewUrl || asset.path} />
              </div>
            )}
