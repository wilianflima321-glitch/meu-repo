...
export const ContentBrowser: React.FC<ContentBrowserProps> = ({
  ...
  const [filterType, setFilterType] = useState<ContentBrowserFilterType>(filterTypeValue ?? 'all');
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        >
          ...
          <select
            ...
            onChange={(e) => {
              const value = e.target.value as ContentBrowserFilterType;
              setFilterType(value);
