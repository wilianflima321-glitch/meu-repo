...
/**
 * LocalBYOKSection — stores provider keys directly in `localStorage`.
 * Keys NEVER leave the browser. Use alongside the server-side BYOKVaultPanel
 * for redundant coverage (server vault = cloud agents; local = Tauri desktop
 * and browser direct dispatch).
 */
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-[var(--aethel-text-tertiary)]">
            Stored in localStorage only — never sent to Aethel servers.
          </p>
        </div>
      </div>
