            ...
            <div className="flex shrink-0 flex-wrap gap-2">
              ...
              {onDismissEntryIntent ? (
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-2 text-sm font-medium text-slate-300 transition hover:border-white/20 hover:text-white"
                >
                  Ocultar contexto
                </button>
              ) : null}
