      ...
      <div className="grid grid-cols-1 md:grid-cols-2 aethel-gap-6">
        ...
        <div className="aethel-card aethel-p-6">
          ...
          <div className="space-y-3">
            <div className="aethel-flex aethel-items-center aethel-gap-3 aethel-p-2 bg-[color-mix(in_srgb,var(--aethel-error)_10%,transparent)] aethel-rounded-lg">
              <div className="w-2 h-2 bg-[var(--aethel-error)] rounded-full"></div>
              <span className="text-xs text-[var(--aethel-error)]">3 Tentativas de login suspeitas detectadas</span>
            </div>
            <div className="aethel-flex aethel-items-center aethel-gap-3 aethel-p-2 bg-[color-mix(in_srgb,var(--aethel-warning)_10%,transparent)] aethel-rounded-lg">
              <div className="w-2 h-2 bg-[var(--aethel-warning)] rounded-full"></div>
              <span className="text-xs text-[var(--aethel-warning)]">Certificado SSL expira em 15 dias</span>
            </div>
            <div className="aethel-flex aethel-items-center aethel-gap-3 aethel-p-2 bg-[color-mix(in_srgb,var(--aethel-primary)_10%,transparent)] aethel-rounded-lg">
              <div className="w-2 h-2 bg-[var(--aethel-primary)] rounded-full"></div>
