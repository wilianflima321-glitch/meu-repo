  ...
  return (
    <div className="aethel-p-6 space-y-8">
      <div className="text-center">
        ...
        <p className="text-[var(--aethel-text-secondary)]">Exemplos práticos de como o Aethel pode acelerar seu fluxo de trabalho</p>
      </div>
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1">
                ...
                {useCase.features.length > 3 && (
                  <li className="text-xs text-[var(--aethel-text-tertiary)]">+ {useCase.features.length - 3} mais</li>
                )}
              </ul>
            </div>
