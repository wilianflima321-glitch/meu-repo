...
import { OptionButton, SearchInput, SearchResultFile } from './GlobalSearch.parts';
        ...
        {showFilters && (
          <div className="space-y-2 pl-4">
            <input
              ...
              placeholder="Files to include (for example: *.ts, src/**)"
        ...
        {state.searching ? (
          ...
          <div className="px-4 py-12 text-center text-[var(--aethel-text-quaternary)]">
            ...
            <p className="text-xs mt-1">
              Try different terms or adjust the filters
            </p>
          </div>
