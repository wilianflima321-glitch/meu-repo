        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <button
                onClick={handlePull}
                className="px-4 py-2 bg-[var(--aethel-primary)] hover:brightness-110 text-white rounded-lg transition-colors"
              >
                Pull
              </button>
              <button
                ...
                className="px-4 py-2 bg-[var(--aethel-success)] hover:brightness-110 disabled:bg-[var(--aethel-surface-quaternary)] text-white rounded-lg transition-colors"
              >
                Push ({status?.ahead || 0})
              </button>
            </div>
        ...
        {status && status.staged.length > 0 && (
          <div className="mt-6 bg-[color-mix(in_srgb,var(--aethel-surface-secondary)_50%,transparent)] backdrop-blur-sm rounded-lg p-4">
            ...
            <textarea
              ...
              className="w-full p-3 bg-[var(--aethel-surface-quaternary)] text-white rounded-lg mb-3 resize-none focus:outline-none focus:ring-2 focus:ring-[var(--aethel-info)]"
              rows={3}
            />
            <button
              onClick={handleCommit}
              disabled={!commitMessage.trim()}
              className="w-full px-4 py-2 bg-[var(--aethel-primary)] hover:brightness-110 disabled:bg-[var(--aethel-surface-quaternary)] text-white rounded-lg transition-colors"
            >
