...
const contract =
  readOptional('lib/runtime/v29-internal-spine.ts') ||
  readOptional('../packages/runtime/v29-internal-spine.ts')
if (!contract) failures.push('missing file: v29-internal-spine.ts (web lib or packages/runtime)')
...
for (const token of [
  'filesystem_guards_scope_reads_writes_and_listing_to_the_project_root',
  'terminal_write_and_close_fail_for_unknown_session',
...
console.log(`[v29-desktop-bridge-commands] PASS commands=${commands.length} pty=available`)
