...
requirePattern('app/admin/admin-ops-layout-client.tsx', /Global Legacy compatibility map/, 'legacy compatibility disclosure must be one global searchable drawer')
