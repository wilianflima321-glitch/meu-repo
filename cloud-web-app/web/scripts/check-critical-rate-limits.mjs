...
const ROUTE_EXPECTATIONS = [
  ...
  { file: 'app/api/terminal/action/route.ts', scope: 'terminal-action-post' },
  { file: 'app/api/terminal/close/route.ts', scope: 'terminal-close-post' },
  { file: 'app/api/terminal/create/route.ts', scope: 'terminal-create-post' },
  { file: 'app/api/terminal/input/route.ts', scope: 'terminal-input-post' },
  { file: 'app/api/terminal/kill/route.ts', scope: 'terminal-kill-post' },
  { file: 'app/api/terminal/resize/route.ts', scope: 'terminal-resize-post' },
  { file: 'app/api/terminal/sandbox/route.ts', scope: 'terminal-sandbox-post' },
  { file: 'app/api/terminal/sandbox/route.ts', scope: 'terminal-sandbox-delete' },
  { file: 'app/api/terminal/sandbox/route.ts', scope: 'terminal-sandbox-get' },
  { file: 'app/api/chat/orchestrator/route.ts', scope: 'chat-orchestrator-post' },
  { file: 'app/api/chat/threads/route.ts', scope: 'chat-threads-get' },
  { file: 'app/api/chat/threads/route.ts', scope: 'chat-threads-post' },
  { file: 'app/api/chat/threads/[id]/route.ts', scope: 'chat-thread-detail-get' },
  { file: 'app/api/chat/threads/[id]/route.ts', scope: 'chat-thread-detail-patch' },
  { file: 'app/api/chat/threads/[id]/route.ts', scope: 'chat-thread-detail-delete' },
  { file: 'app/api/chat/threads/[id]/messages/route.ts', scope: 'chat-thread-messages-get' },
  { file: 'app/api/chat/threads/[id]/messages/route.ts', scope: 'chat-thread-messages-post' },
  { file: 'app/api/chat/threads/clone/route.ts', scope: 'chat-thread-clone-post' },
  { file: 'app/api/chat/threads/merge/route.ts', scope: 'chat-thread-merge-post' },
  { file: 'app/api/git/route.ts', scope: 'git-post' },
  { file: 'app/api/git/route.ts', scope: 'git-get' },
  { file: 'app/api/git/add/route.ts', scope: 'git-add-post' },
  { file: 'app/api/git/status/route.ts', scope: 'git-status-post' },
  { file: 'app/api/git/checkout/route.ts', scope: 'git-checkout-post' },
  { file: 'app/api/git/commit/route.ts', scope: 'git-commit-post' },
  { file: 'app/api/git/pull/route.ts', scope: 'git-pull-post' },
  { file: 'app/api/git/push/route.ts', scope: 'git-push-post' },
  { file: 'app/api/git/branch/route.ts', scope: 'git-branch-post' },
  { file: 'app/api/git/branch/route.ts', scope: 'git-branch-get' },
  { file: 'app/api/git/branch/route.ts', scope: 'git-branch-delete' },
  { file: 'app/api/jobs/route.ts', scope: 'jobs-get' },
  { file: 'app/api/jobs/route.ts', scope: 'jobs-post' },
  { file: 'app/api/jobs/start/route.ts', scope: 'jobs-start-post' },
  { file: 'app/api/jobs/start/route.ts', scope: 'jobs-start-get' },
  { file: 'app/api/jobs/stats/route.ts', scope: 'jobs-stats-get' },
  { file: 'app/api/jobs/stop/route.ts', scope: 'jobs-stop-post' },
  { file: 'app/api/jobs/[id]/route.ts', scope: 'jobs-id-get' },
  { file: 'app/api/jobs/[id]/route.ts', scope: 'jobs-id-delete' },
  { file: 'app/api/jobs/[id]/retry/route.ts', scope: 'jobs-id-retry-post' },
  { file: 'app/api/jobs/[id]/cancel/route.ts', scope: 'jobs-id-cancel-post' },
