...
const ROUTE_EXPECTATIONS = [
  ...
  { file: 'app/api/auth/forgot-password/route.ts', scope: 'auth-forgot-password-post' },
  { file: 'app/api/auth/reset-password/route.ts', scope: 'auth-reset-password-post' },
  { file: 'app/api/auth/verify-email/route.ts', scope: 'auth-verify-email-post' },
  { file: 'app/api/auth/verify-email/route.ts', scope: 'auth-verify-email-get' },
  ...
  { file: 'app/api/marketplace/route.ts', scope: 'marketplace-route-get' },
  { file: 'app/api/marketplace/route.ts', scope: 'marketplace-route-post' },
  { file: 'app/api/marketplace/extensions/route.ts', scope: 'marketplace-extensions-get' },
  { file: 'app/api/marketplace/install/route.ts', scope: 'marketplace-install-post' },
  { file: 'app/api/marketplace/uninstall/route.ts', scope: 'marketplace-uninstall-post' },
  { file: 'app/api/marketplace/assets/route.ts', scope: 'marketplace-assets-get' },
  { file: 'app/api/marketplace/assets/route.ts', scope: 'marketplace-assets-post' },
  { file: 'app/api/marketplace/cart/route.ts', scope: 'marketplace-cart-get' },
  { file: 'app/api/marketplace/cart/route.ts', scope: 'marketplace-cart-post' },
  { file: 'app/api/marketplace/cart/route.ts', scope: 'marketplace-cart-delete' },
  { file: 'app/api/marketplace/favorites/route.ts', scope: 'marketplace-favorites-get' },
  { file: 'app/api/marketplace/favorites/[assetId]/route.ts', scope: 'marketplace-favorite-asset-post' },
  { file: 'app/api/marketplace/favorites/[assetId]/route.ts', scope: 'marketplace-favorite-asset-delete' },
  { file: 'app/api/marketplace/creator/assets/route.ts', scope: 'marketplace-creator-assets-get' },
  { file: 'app/api/marketplace/creator/categories/route.ts', scope: 'marketplace-creator-categories-get' },
  { file: 'app/api/marketplace/creator/revenue/route.ts', scope: 'marketplace-creator-revenue-get' },
  { file: 'app/api/marketplace/creator/sales/recent/route.ts', scope: 'marketplace-creator-sales-recent-get' },
  { file: 'app/api/marketplace/creator/stats/route.ts', scope: 'marketplace-creator-stats-get' },
  { file: 'app/api/copilot/action/route.ts', scope: 'copilot-action-post' },
  { file: 'app/api/copilot/context/route.ts', scope: 'copilot-context-get' },
  { file: 'app/api/copilot/context/route.ts', scope: 'copilot-context-post' },
  { file: 'app/api/copilot/workflows/route.ts', scope: 'copilot-workflows-get' },
  { file: 'app/api/copilot/workflows/route.ts', scope: 'copilot-workflows-post' },
  { file: 'app/api/copilot/workflows/[id]/route.ts', scope: 'copilot-workflow-detail-get' },
  { file: 'app/api/copilot/workflows/[id]/route.ts', scope: 'copilot-workflow-detail-patch' },
  { file: 'app/api/dap/events/route.ts', scope: 'dap-events-get' },
  { file: 'app/api/dap/processes/route.ts', scope: 'dap-processes-get' },
  { file: 'app/api/dap/request/route.ts', scope: 'dap-request-post' },
  { file: 'app/api/dap/session/start/route.ts', scope: 'dap-session-start-post' },
  { file: 'app/api/dap/session/stop/route.ts', scope: 'dap-session-stop-post' },
  { file: 'app/api/lsp/request/route.ts', scope: 'lsp-request-post' },
  { file: 'app/api/lsp/notification/route.ts', scope: 'lsp-notification-post' },
  { file: 'app/api/search/route.ts', scope: 'search-post' },
  { file: 'app/api/search/route.ts', scope: 'search-get' },
  { file: 'app/api/search/replace/route.ts', scope: 'search-replace-post' },
  { file: 'app/api/collaboration/rooms/route.ts', scope: 'collaboration-rooms-get' },
  { file: 'app/api/collaboration/rooms/route.ts', scope: 'collaboration-rooms-post' },
  { file: 'app/api/collaboration/rooms/[id]/route.ts', scope: 'collaboration-room-detail-get' },
  { file: 'app/api/collaboration/rooms/[id]/route.ts', scope: 'collaboration-room-detail-post' },
  { file: 'app/api/collaboration/rooms/[id]/route.ts', scope: 'collaboration-room-detail-delete' },
  ...
  { file: 'app/api/credits/transfer/route.ts', scope: 'credits-transfer-post' },
  { file: 'app/api/usage/status/route.ts', scope: 'usage-status-get' },
  { file: 'app/api/contact/route.ts', scope: 'contact-post' },
  { file: 'app/api/email/route.ts', scope: 'email-post' },
  { file: 'app/api/backup/route.ts', scope: 'backup-get' },
  { file: 'app/api/backup/route.ts', scope: 'backup-post' },
  { file: 'app/api/backup/route.ts', scope: 'backup-delete' },
  { file: 'app/api/backup/restore/route.ts', scope: 'backup-restore-post' },
  { file: 'app/api/test/discover/route.ts', scope: 'test-discover-post' },
  { file: 'app/api/test/run/route.ts', scope: 'test-run-post' },
  { file: 'app/api/mcp/route.ts', scope: 'mcp-post' },
  { file: 'app/api/mcp/route.ts', scope: 'mcp-get' },
  { file: 'app/api/analytics/route.ts', scope: 'analytics-get' },
  { file: 'app/api/analytics/route.ts', scope: 'analytics-post' },
  { file: 'app/api/experiments/route.ts', scope: 'experiments-get' },
  { file: 'app/api/experiments/route.ts', scope: 'experiments-post' },
  { file: 'app/api/feature-flags/route.ts', scope: 'feature-flags-get' },
  { file: 'app/api/feature-flags/route.ts', scope: 'feature-flags-post' },
  { file: 'app/api/feature-flags/[key]/toggle/route.ts', scope: 'feature-flag-toggle-post' },
  { file: 'app/api/notifications/route.ts', scope: 'notifications-get' },
  { file: 'app/api/notifications/route.ts', scope: 'notifications-post' },
  { file: 'app/api/notifications/route.ts', scope: 'notifications-patch' },
  { file: 'app/api/notifications/route.ts', scope: 'notifications-delete' },
  { file: 'app/api/onboarding/route.ts', scope: 'onboarding-get' },
  { file: 'app/api/onboarding/route.ts', scope: 'onboarding-post' },
  { file: 'app/api/quotas/route.ts', scope: 'quotas-get' },
  { file: 'app/api/quotas/route.ts', scope: 'quotas-post' },
  { file: 'app/api/templates/route.ts', scope: 'templates-get' },
