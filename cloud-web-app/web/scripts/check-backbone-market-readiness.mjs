...
const DOMAINS = [
  ...
  },
  {
    ...
    files: [
      ...
      'lib/production/governed-runtime-jobs.ts',
      'lib/production/runtime-job-receipts.ts',
      'app/api/projects/[id]/production-state/runtime-job-receipts/route.ts',
  ...
  },
  {
    ...
    tokens: [
      ...
      'qa:release-evidence-readiness',
      'qa:runtime-job-receipts',
