...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*19/, 'admin physical route ratchet')
...
if (adminPages.length > 19) failures.push(`admin physical routes ${adminPages.length} > 19`)
...
- Admin physical routes: ${adminPages.length}/19
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/19 studioRoutes=${studioPages.length}/7`)
