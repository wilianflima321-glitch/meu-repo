...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*17/, 'admin physical route ratchet')
...
if (adminPages.length > 17) failures.push(`admin physical routes ${adminPages.length} > 17`)
...
- Admin physical routes: ${adminPages.length}/17
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/17 studioRoutes=${studioPages.length}/7`)
