...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*18/, 'admin physical route ratchet')
...
if (adminPages.length > 18) failures.push(`admin physical routes ${adminPages.length} > 18`)
...
- Admin physical routes: ${adminPages.length}/18
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/18 studioRoutes=${studioPages.length}/7`)
