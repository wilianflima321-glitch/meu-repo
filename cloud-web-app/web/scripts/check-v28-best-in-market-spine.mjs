...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*13/, 'admin physical route ratchet')
...
if (adminPages.length > 13) failures.push(`admin physical routes ${adminPages.length} > 13`)
...
- Admin physical routes: ${adminPages.length}/13
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/13 studioRoutes=${studioPages.length}/7`)
