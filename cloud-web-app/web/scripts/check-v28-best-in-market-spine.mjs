...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*14/, 'admin physical route ratchet')
...
if (adminPages.length > 14) failures.push(`admin physical routes ${adminPages.length} > 14`)
...
- Admin physical routes: ${adminPages.length}/14
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/14 studioRoutes=${studioPages.length}/7`)
