...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*22/, 'admin physical route ratchet')
...
if (adminPages.length > 22) failures.push(`admin physical routes ${adminPages.length} > 22`)
...
- Admin physical routes: ${adminPages.length}/22
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/22 studioRoutes=${studioPages.length}/7`)
