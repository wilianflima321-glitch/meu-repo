...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*15/, 'admin physical route ratchet')
...
if (adminPages.length > 15) failures.push(`admin physical routes ${adminPages.length} > 15`)
...
- Admin physical routes: ${adminPages.length}/15
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/15 studioRoutes=${studioPages.length}/7`)
