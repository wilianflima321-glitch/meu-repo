...
requirePattern('lib/routes/product-surface-registry.ts', /maxAdminPhysicalRoutes:\s*16/, 'admin physical route ratchet')
...
if (adminPages.length > 16) failures.push(`admin physical routes ${adminPages.length} > 16`)
...
- Admin physical routes: ${adminPages.length}/16
...
console.log(`[v28-best-in-market-spine] PASS surfaces=6 adminRoutes=${adminPages.length}/16 studioRoutes=${studioPages.length}/7`)
