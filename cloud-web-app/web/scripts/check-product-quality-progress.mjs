...
requirePattern('app/marketplace/creator/onboarding/page.tsx', /Stripe Express/, 'creator payout onboarding must surface the real Stripe Express flow')
requirePattern('app/marketplace/creator/onboarding/page.tsx', /\/api\/marketplace\/creator\/connect/, 'creator payout onboarding must call the payout onboarding API')
