...
for (const token of ['CreativeToolchainContract', 'V29_CREATIVE_TOOLCHAIN_CONTRACT', 'CreativeStudioShell', 'ViewportChrome', 'SceneViewportInspector', 'SceneViewportOutliner', 'TimelineOverlay', 'EngineContentBrowser', 'human-review-required']) {
...
console.log('[v29-creative-toolchain-contract] PASS shell=CreativeStudioShell')
