...
requirePattern('lighthouserc.js', /'categories:pwa':\s*\['error',\s*\{\s*minScore:\s*0\.85\s*\}\]/, 'PWA category must be an error gate at 0.85+')
requireFile('lighthouserc.pwa.js', 'dedicated PWA Lighthouse config must exist')
requirePattern('lighthouserc.pwa.js', /'categories:pwa':\s*\['error',\s*\{\s*minScore:\s*0\.85\s*\}\]/, 'dedicated PWA audit must fail below 0.85')
requirePattern('../../.github/workflows/lighthouse-ci.yml', /lighthouserc\.pwa\.js/, 'workflow must run the dedicated PWA audit')
