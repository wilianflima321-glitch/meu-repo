...
export default function RateLimitingPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-4 flex items-center justify-between gap-3">
        <input
          type="text"
        ...
        />
        <span className="text-xs text-gray-500">{filteredLimits.length} regras</span>
      </div>
              ...
              <li key={limit.name} className="p-4 border-b">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Algoritmo: {limit.algorithm} • Identificador: {limit.identifier}</p>
                  </div>
