        ...
        <table className='w-full'>
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td className='p-3 text-sm text-[var(--aethel-error)]' colSpan={5}>{error}</td>
              </tr>
              ...
              filteredPlans.map((plan) => (
                <tr key={plan.id} className='border-t hover:bg-[color-mix(in_srgb,var(--aethel-surface-secondary)_60%,transparent)]'>
