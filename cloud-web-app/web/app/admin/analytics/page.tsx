  ...
  return (
    <div className='mx-auto max-w-6xl p-6'>
      ...
      {baseline?.dataQuality?.hasAnyMissingSamples && (
        <div role='status' aria-live='polite' className='rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 text-[var(--aethel-text-secondary)] mb-4'>
