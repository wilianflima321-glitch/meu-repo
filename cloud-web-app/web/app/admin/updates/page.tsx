    ...
    <div className='p-6 max-w-6xl mx-auto'>
      <div className='flex items-center justify-between mb-6'>
        <div>
          ...
          <p className='text-sm text-gray-500'>A IA monitora lançamentos e mudanças de versão detectadas por logs.</p>
          {lastUpdated && (
      ...
      <div className='bg-white rounded-lg shadow p-4'>
        ...
        <table className='w-full table-auto'>
          ...
          <tbody>
            {loading ? (
              <tr>
                <td className='p-2 text-sm text-gray-500' colSpan={5}>Carregando atualizações...</td>
              </tr>
            ) : filteredItems.length === 0 ? (
              <tr>
                <td className='p-2 text-sm text-gray-500' colSpan={5}>Nenhuma atualização encontrada.</td>
              </tr>
            ) : (
