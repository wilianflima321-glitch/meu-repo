        ...
        <section className="min-w-0 rounded-lg border border-[var(--aethel-border-primary)] bg-[color-mix(in_srgb,var(--aethel-surface-secondary)_40%,transparent)]">
            ...
            {activeTab === 'api' && (
              <div className="p-4 sm:p-6">
                ...
                {providerError && (
                  <div className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 border-[color-mix(in_srgb,var(--aethel-error)_40%,transparent)] bg-[color-mix(in_srgb,var(--aethel-error)_10%,transparent)] text-[var(--aethel-error-light)] mt-4 text-xs" role="alert" aria-live="polite">
                    {providerError}
                  </div>
                )}
                {providerLoading && (
                  <div className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 text-[var(--aethel-text-secondary)] mt-4 text-xs" aria-live="polite">
                ...
                {!providerLoading && (
                  <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div className="rounded border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-primary)]/40 p-3">
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {configuredProviders.length === 0 && (
                          <span className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 text-[var(--aethel-text-tertiary)] text-xs">Nenhum provider configurado.</span>
                        )}
                    ...
                    <div className="rounded border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-primary)]/40 p-3">
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {missingProviders.length === 0 && <span className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 text-[var(--aethel-text-tertiary)] text-xs">Nenhum pendente.</span>}
                ...
                {!providerLoading && providerStatusLoaded && configuredProviders.length === 0 && missingProviders.length === 0 && !providerError && (
                  <div className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 text-[var(--aethel-text-tertiary)] mt-4 text-xs">
