            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {categories.map((category) => (
                <button type="button"
                  ...
                  className={`rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] transition-colors ${ selectedCategory === category ? 'bg-[color-mix(in_srgb,var(--aethel-accent)_20%,transparent)] text-[var(--aethel-accent-light)] border border-[color-mix(in_srgb,var(--aethel-accent)_35%,transparent)]' : 'border border-[var(--aethel-border-subtle)] bg-[color-mix(in_srgb,var(--aethel-surface-secondary)_30%,transparent)] text-[var(--aethel-text-secondary)] hover:text-[var(--aethel-text-primary)]' }`}
                >
                    ...
                    {ext.installed ? (
                      <>
                        <button type="button"
                          ...
                          className="inline-flex items-center justify-center gap-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aethel-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--aethel-surface-primary)] bg-[var(--aethel-error)] text-[var(--aethel-text-inverse)] hover:bg-[var(--aethel-error-dark)] w-full rounded-xl px-3 py-2 text-xs font-semibold"
                        >
                          Desinstalar
                        </button>
                        <button type="button" className="inline-flex items-center justify-center gap-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aethel-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--aethel-surface-primary)] bg-[var(--aethel-surface-tertiary)] text-[var(--aethel-text-primary)] hover:bg-[var(--aethel-surface-quaternary)] rounded-xl px-3 py-2 text-xs font-semibold">
                          Configurar
                        </button>
                      </>
                    ) : (
