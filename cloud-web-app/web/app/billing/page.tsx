...
export default function BillingPage() {
  ...
  if (isLoading) {
    ...
    <StudioLayout title="Faturamento" subtitle="Planos, consumo e faturamento do workspace.">
        <div className="flex items-center justify-center px-6 py-12">
          <div className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 p-6">
  ...
  if (error) {
    ...
    <StudioLayout title="Faturamento" subtitle="Planos, consumo e faturamento do workspace.">
        <div className="flex items-center justify-center px-6 py-12">
          <div className="rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 p-6 max-w-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`rounded-lg border border-[var(--aethel-border-primary)] bg-[var(--aethel-surface-secondary)] p-4 p-6 flex flex flex-col ${plan.popular ? 'border border-[var(--aethel-border-secondary)]' : ''}`}
              >
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aethel-focus)] bg-[var(--aethel-primary)] text-[var(--aethel-text-inverse)] hover:brightness-110 w-full ${isBusy ? 'opacity-50' : ''}`}
                >
                  {isBusy
                    ? 'Processando...'
                    : isEnterprise
