...
export const CREATIVE_STUDIO_ROUTE_REDIRECTS: Record<string, string> = {
  ...
  '/studio/gen-world': '/studio/level?tool=gen-world',
  ...
  '/studio/game-ready-gen': '/studio/animation?tool=game-ready-gen',
...
export const CREATIVE_STUDIO_ROUTES: CreativeStudioRoute[] = [
  ...
  },
  {
    ...
    maturity: 'BETA',
    description:
      'Durable heightfield sculpt+paint+foliage+erosion; World Forge IDE wire CLOSED (cd); LoRA/Partition/GPU Recast [HELD].',
  },
  {
    href: '/studio/gen-world',
    label: 'Generate world',
    shortLabel: 'World Forge',
    domain: 'world',
    group: 'world',
    maturity: 'BETA',
    description:
      'Text -> SDF heightfield + biome + PCG scatter + CPU NavMesh + FusionTx (letter cd). Math PCG ready; LoRA/ONNX [HELD].',
  },
  {
    href: '/studio/cloth',
    label: 'Cloth',
  ...
  {
    href: '/studio/game-ready-gen',
    label: 'Generate character',
    shortLabel: 'Gen',
    domain: 'world',
    group: 'character',
    maturity: 'ALPHA',
    description: 'Text → native pager or BYOK clay poll → game-ready conveyor with FusionTx and honesty badges.',
  },
