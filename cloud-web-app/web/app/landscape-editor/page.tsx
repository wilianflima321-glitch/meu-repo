...
/**
 * Landscape Editor Page
 * Página do editor de terrenos/paisagens
 */
...
const LandscapeEditor = dynamic(
  () => import('@/components/engine/LandscapeEditor'),
  { 
    ssr: false,
    loading: () => (
      <div className="flex items-center justify-center h-screen bg-[#1e1e1e]">
        <div className="text-center">
          ...
          <div className="text-white">Carregando editor de paisagens...</div>
        </div>
      </div>
    )
  }
