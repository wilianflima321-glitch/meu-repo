...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    id: 4,
    title: 'Arcade publish tour (simulation)',
    description: 'Learn the Arcade publish flow. Real publish requires a Web export — this step is a guided tour only [HELD].',
    actionLabel: 'Complete tour step',
          ...
          {arcadePublished && (
            <div className="absolute inset-0 bg-black/80 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center z-20 animate-fade-in">
              ...
              <p className="mt-2 text-sm text-[var(--aethel-text-secondary)] max-w-md">
                You finished the guided interface tour. Arcade listing stays [HELD] until a real Web export publish succeeds — this step did not publish a live build.
              </p>
