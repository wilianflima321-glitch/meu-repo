...
const features = [
  { icon: '🏢', title: 'SSO/SAML', desc: 'Single Sign-On para toda a organização' },
  { icon: '🔐', title: 'SOC2 Compliance', desc: 'Segurança de nível enterprise' },
  { icon: '📊', title: 'Analytics Avançados', desc: 'Métricas detalhadas de uso e performance' },
  { icon: '🎯', title: 'SLA 99.99%', desc: 'Uptime garantido em contrato' },
  { icon: '👤', title: 'Gerente Dedicado', desc: 'Suporte personalizado para seu time' },
  { icon: '🚀', title: 'Onboarding Custom', desc: 'Treinamento e setup personalizado' },
];
      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
        ...
        <div className="relative text-center max-w-lg">
          ...
          <p className="text-slate-400 text-lg mb-8">
            Obrigado pelo seu interesse. Nossa equipe de vendas entrará em contato em até 24 horas úteis.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="lg:pt-8">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-300 text-sm font-medium mb-6">
                Enterprise
              </span>
              ...
              <p className="text-xl text-slate-400 mb-10 leading-relaxed">
                Agende uma demonstração personalizada e descubra como o Aethel pode transformar a produtividade do seu time de desenvolvimento.
              </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full h-12 px-4 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all resize-none"
                  ...
                  <button
                    ...
                    className="w-full h-12 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold rounded-xl hover:from-violet-500 hover:to-fuchsia-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
