...
const editors: EditorCard[] = [
  // === UNIFIED STUDIO (PRINCIPAL) ===
  {
    id: 'unified-studio',
    name: '🚀 Unified Studio',
    description: 'Interface unificada profissional com todos os editores integrados. Layout estilo Unreal Engine 5.',
    icon: '🚀',
    href: '/studio',
    color: 'from-purple-600 via-blue-600 to-cyan-600',
    features: ['All Editors', 'Dockable Panels', 'Tabs', 'Professional UI'],
    status: 'stable',
  },
  // === CORE EDITORS ===
  {
  ...
  {
    id: 'control-rig',
    name: 'Control Rig Editor',
    description: 'Editor de control rigs para animação procedural e IK.',
    icon: '🦴',
    href: '/control-rig',
    color: 'from-lime-600 to-lime-800',
    features: ['IK Solvers', 'Bone Chains', 'Constraints', 'Real-time Preview'],
    status: 'stable',
  },
  {
    id: 'facial-editor',
    name: 'Facial Animation',
    description: 'Editor de animação facial com blend shapes e mocap.',
    icon: '😀',
    href: '/facial-editor',
    color: 'from-rose-600 to-rose-800',
    features: ['Blend Shapes', 'ARKit Support', 'Lip Sync', 'Emotion Presets'],
    status: 'beta',
  },
  // === TERRAIN & ENVIRONMENT ===
  {
  ...
  },
  {
    ...
    name: 'Terrain Sculpting Pro',
    description: 'Editor avançado de escultura de terrenos com ferramentas profissionais.',
    icon: '⛏️',
    href: '/terrain-sculpting',
    color: 'from-amber-600 to-amber-800',
    features: ['Advanced Brushes', 'Procedural Generation', 'Erosion Sim', 'LOD System'],
    status: 'beta',
  },
  // === SIMULATION EDITORS ===
  {
    ...
    description: 'Editor de simulação de fluidos com preview 3D em tempo real.',
    icon: '💧',
    href: '/fluid-editor',
    color: 'from-sky-600 to-sky-800',
    features: ['Water Physics', 'Real-time Preview', 'GPU Accelerated', 'Bake to Mesh'],
    status: 'beta',
  },
  {
    id: 'cloth-editor',
    name: 'Cloth Simulation',
    description: 'Editor de simulação de tecidos com física realista.',
    icon: '👕',
    href: '/cloth-editor',
    color: 'from-violet-600 to-violet-800',
    features: ['Physics Sim', 'Collision Detection', 'Wind Forces', 'Real-time Preview'],
    status: 'beta',
  },
  {
    id: 'hair-editor',
    name: 'Hair & Fur Editor',
    description: 'Editor de cabelo e pelos com simulação física.',
    icon: '💇',
    href: '/hair-editor',
    color: 'from-yellow-600 to-yellow-800',
    features: ['Strand Editing', 'Physics Sim', 'Grooming Tools', 'LOD System'],
    status: 'beta',
  },
  // === AUDIO & CINEMATICS ===
  {
    id: 'sound-editor',
    name: 'Sound Cue Editor',
    description: 'Editor de sound cues e áudio 3D espacial.',
    icon: '🔊',
    href: '/sound-editor',
    color: 'from-indigo-600 to-indigo-800',
    features: ['3D Audio', 'Sound Mixing', 'Attenuation', 'Reverb Zones'],
    status: 'stable',
  },
  {
    id: 'video-timeline',
    name: 'Sequencer / Timeline',
  ...
  },
  {
    id: 'media-studio',
    name: 'Media Studio',
    description: 'Estúdio completo de criação de mídia (áudio, vídeo, imagens).',
    icon: '🎞️',
    href: '/media-studio',
    color: 'from-fuchsia-600 to-fuchsia-800',
    features: ['Video Editing', 'Audio Mixing', 'Image Processing', 'AI Generation'],
    status: 'beta',
  },
  // === GAMEPLAY EDITORS ===
  {
    ...
    description: 'Editor de diálogos com árvores de conversação.',
    icon: '💬',
    href: '/dialogue-editor',
    color: 'from-teal-600 to-teal-800',
    features: ['Dialogue Trees', 'Conditions', 'Localization', 'Voice Integration'],
    status: 'stable',
  },
  {
    id: 'quest-editor',
    name: 'Quest Editor',
    description: 'Editor de missões e objetivos de gameplay.',
    icon: '📜',
    href: '/quest-editor',
    color: 'from-amber-600 to-amber-800',
    features: ['Quest Chains', 'Objectives', 'Rewards', 'Branching Paths'],
    status: 'stable',
  },
  // === TOOLS & UTILITIES ===
  {
    ...
    description: 'Browser avançado de assets do projeto.',
    icon: '📂',
    href: '/content-browser',
    color: 'from-slate-600 to-slate-800',
    features: ['Asset Preview', 'Bulk Operations', 'Filters', 'Collections'],
    status: 'stable',
  },
  {
    id: 'export-system',
    name: 'Export System',
    description: 'Sistema de exportação para múltiplas plataformas.',
    icon: '📦',
    href: '/export',
    color: 'from-blue-600 to-blue-800',
    features: ['Windows', 'Linux', 'macOS', 'Web', 'iOS', 'Android'],
    status: 'stable',
  },
  {
    id: 'project-settings',
  ...
  // === MORE TOOLS ===
  {
    ...
    description: 'Editor de visual scripting alternativo ao Blueprint.',
    icon: '🔗',
    href: '/visual-script',
    color: 'from-cyan-600 to-cyan-800',
    features: ['Node Graph', 'Visual Logic', 'Custom Nodes', 'Templates'],
    status: 'beta',
  },
  {
    id: 'marketplace-pro',
    name: 'Marketplace Pro',
    description: 'Browser avançado do marketplace com preview 3D.',
    icon: '🏪',
    href: '/marketplace-pro',
    color: 'from-emerald-600 to-emerald-800',
    features: ['3D Preview', 'Advanced Filters', 'Collections', 'Reviews'],
    status: 'beta',
  },
];
...
const quickActions = [
  ...
  { label: 'Open Project', icon: '📂', action: '/content-browser' },
  { label: 'Import Asset', icon: '📥', action: '/content-browser' },
