...
export async function POST(req: NextRequest): Promise<Response> {
  ...
  try {
    // Law #48 — agents never host PTY / cloud-container shell as local.
    ...
    if (callerKind === 'agent') {
      ...
      log.warn('[SECURITY] AgentShellPolicy blocked agent host/cloud PTY', {
        userId: user.userId,
        action: 'terminal.agent_shell_blocked',
