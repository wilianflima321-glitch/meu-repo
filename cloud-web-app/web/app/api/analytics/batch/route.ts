...
function normalizeEvent(event: AnalyticsEventPayload, index: number): NormalizedEntry {
...
function normalizeMetric(metric: AnalyticsMetricPayload, index: number): NormalizedEntry {
