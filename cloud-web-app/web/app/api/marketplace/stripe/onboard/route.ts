...
import { enforceRouteRateLimit, MARKETPLACE_STRIPE_CONNECT_RATE_LIMIT } from '@/lib/server/route-rate-limit';
...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  const rateLimited = await enforceRouteRateLimit({
    req,
    capability: 'MARKETPLACE_STRIPE_ONBOARD',
    route: '/api/marketplace/stripe/onboard',
