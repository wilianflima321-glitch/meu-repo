...
const routeLogger = createComponentLogger('api/marketplace/creator/stats/route');
...
export async function GET(request: NextRequest) {
  try {
    ...
    const rateLimited = await enforceRouteRateLimit({
      req: request,
      capability: 'MARKETPLACE_CREATOR_STATS',
      route: '/api/marketplace/creator/stats',
    ...
    routeLogger.error('[marketplace/creator/stats] Error:', error);
