...
// Law I (bk) — COOP/COEP on play/runtime/studio/ide (SharedArrayBuffer / crossOriginIsolated).
// credentialless: Chromium COI without breaking non-CORP CDN fonts/scripts.
...
const nextConfig = {
  ...
  async headers() {
    return [
      ...
      ...sabIsolationSources.map((source) => ({
        source,
