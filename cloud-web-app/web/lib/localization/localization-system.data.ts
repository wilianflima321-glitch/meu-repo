/**
 * Locale defaults and plural rules for the Aethel localization runtime.
 */

import type { LocaleConfig, PluralRule } from './localization-system.types';
...
export const DEFAULT_LOCALE_CONFIGS: Record<string, LocaleConfig> = {
  'en-US': {
    code: 'en-US',
    name: 'English',
    nativeName: 'English',
