...
/**
 * Aethel localization runtime.
 *
 * Locale switching, formatting, fallbacks and interpolation.
 */

import { EventEmitter } from 'events';
import { DEFAULT_LOCALE_CONFIGS, PLURAL_RULES } from './localization-system.data';
import type {
  LocaleCode,
  LocaleConfig,
  PluralRule,
...
export { DEFAULT_LOCALE_CONFIGS, PLURAL_RULES } from './localization-system.data';
export type {
  LocaleCode,
  LocaleConfig,
  PluralRule,
