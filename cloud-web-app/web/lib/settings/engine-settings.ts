...
export function isNaniteViewportEnabled(): boolean {
  // Block 3A.1/3A.2 — Nanite viewport badge/path is stripped. Always false.
  return false
}

export function getViewportFidelitySetting(): string {
  return String(getEngineSetting<string>('engine.viewport.fidelity', 'balanced'))
}
