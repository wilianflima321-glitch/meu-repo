...
export type HotReloadEventType = 'update' | 'reload' | 'error' | 'connected' | 'disconnected' | 'file-changed' | 'build-start' | 'build-end';
...
export const DEFAULT_OPTIONS: HotReloadServerOptions = {
  port: 24678,
  host: 'localhost',
  root: process.cwd(),
  watchPatterns: [
