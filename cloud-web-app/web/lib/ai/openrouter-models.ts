...
/** Fast pool default — autocomplete, bulk, fallback when Premium exhausted. */
export const DEFAULT_FAST_IDE_MODEL_ID = DEFAULT_OPENROUTER_MODEL_ID
/** Premium pool default — best cost/quality for IDE agents (code, planning, tools). */
export const DEFAULT_PREMIUM_IDE_MODEL_ID = 'anthropic/claude-sonnet-4.6'
