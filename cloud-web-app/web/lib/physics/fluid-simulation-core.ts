...
export const FLUID_PRESETS: FluidPreset[] = [
  {
    ...
    params: {
      ...
      restDensity: 1000,
      stiffness: 200,
      color: DOMAIN_FLUID_COLORS.water,
      opacity: 0.7,
      temperature: 20,
    },
  },
  ...
  },
  {
    ...
    params: {
      ...
      restDensity: 1400,
      stiffness: 100,
      color: DOMAIN_FLUID_COLORS.honey,
      opacity: 0.9,
      temperature: 20,
    },
  },
  {
    ...
    params: {
      ...
      restDensity: 2700,
      stiffness: 80,
      color: DOMAIN_FLUID_COLORS.lava,
      opacity: 1,
      temperature: 1200,
    },
  },
  {
    ...
    params: {
      ...
      restDensity: 1060,
      stiffness: 180,
      color: DOMAIN_FLUID_COLORS.blood,
      opacity: 0.95,
      temperature: 37,
    },
  },
  {
    ...
    params: {
      ...
      restDensity: 13500,
      stiffness: 300,
      color: DOMAIN_FLUID_COLORS.mercury,
      opacity: 1,
      temperature: 25,
    },
  },
  {
    ...
    params: {
      ...
      restDensity: 1200,
      stiffness: 50,
      color: DOMAIN_FLUID_COLORS.slime,
      opacity: 0.8,
      temperature: 20,
    },
  },
  {
    ...
    params: {
      ...
      restDensity: 1030,
      stiffness: 180,
      color: DOMAIN_FLUID_COLORS.milk,
      opacity: 1,
      temperature: 4,
    },
  },
