...
// @aethel-heavy-async-boundary Studio/fluid SPH runtime; do not import from public route shells.
import * as THREE from 'three';
import { SPHKernels } from './kernels';
import { SpatialHashGrid } from './spatial-hash-grid';
import type { FluidBoundary, FluidConfig, FluidParticle } from './types';
