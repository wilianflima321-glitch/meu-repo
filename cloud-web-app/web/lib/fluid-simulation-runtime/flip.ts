...
// @aethel-heavy-async-boundary Studio/fluid FLIP runtime; do not import from public route shells.
import * as THREE from 'three';
import type { FluidBoundary, FluidConfig, FluidParticle, GridCell } from './types';
