// @aethel-heavy-async-boundary Shader sources are render-gated and imported only by the PBR runtime.
export const PBR_VERTEX_SHADER = /* glsl */ `
#version 300 es
...
`;
export const PBR_FRAGMENT_SHADER = /* glsl */ `
#version 300 es
precision highp float;
export const float PI = 3.14159265359;
export const float EPSILON = 0.0001;
...
`;
export const BLOOM_THRESHOLD_SHADER = /* glsl */ `
#version 300 es
precision highp float;
in vec2 vUV;
out vec4 fragColor;
...
`;
export const BLOOM_BLUR_SHADER = /* glsl */ `
#version 300 es
precision highp float;
in vec2 vUV;
out vec4 fragColor;
...
export const float weights[5] = float[](0.227027, 0.1945946, 0.1216216, 0.054054, 0.016216);
void main() {
...
export const int KERNEL_SIZE = 64;
...
`;
export const TONEMAP_SHADER = /* glsl */ `
#version 300 es
precision highp float;
in vec2 vUV;
out vec4 fragColor;
