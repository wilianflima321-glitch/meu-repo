...
const PROVIDERS: Record<ManagedPreviewProviderId, ManagedPreviewProviderConfig> = {
  ...
  e2b: {
    ...
    setupEnv: [
      ...
      'AETHEL_PREVIEW_E2B_WORKDIR',
      'AETHEL_PREVIEW_E2B_MAX_FILES',
      'AETHEL_PREVIEW_E2B_MAX_FILE_SIZE_MB',
      'AETHEL_PREVIEW_E2B_UPLOAD_BATCH_SIZE',
      'AETHEL_PREVIEW_E2B_INSTALL_TIMEOUT_MS',
