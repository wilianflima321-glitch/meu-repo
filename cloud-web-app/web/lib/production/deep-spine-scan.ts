...
const DEFAULT_BUDGET: DeepSpineScanBudget = {
  maxFiles: 5_000,
...
const DEFAULT_RUNTIME: ProjectMemoryRuntimeProbe = {
...
const ENGINE_LIB_TARGETS = new Map<string, { agent: string; recommendation: string }>([
  [
    'world-partition.ts',
    {
