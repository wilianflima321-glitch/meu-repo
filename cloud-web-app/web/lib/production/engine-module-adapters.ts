...
import type { AudioGroupConfig, AudioSourceConfig } from '@aethel/engine/audio-manager-contracts';
...
export interface VolumetricCloudAdapterSummary {
  ...
  /** CLOUD-001 — depth blend + god-rays production composite (letter by). */
  shipStatus: 'CLOSED' | 'HELD';
  depthBlend: boolean;
  godRaysInRenderPath: boolean;
