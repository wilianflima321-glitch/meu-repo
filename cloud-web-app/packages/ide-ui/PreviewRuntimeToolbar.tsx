...
export default function PreviewRuntimeToolbar({
  ...
  return (
    <div className="border-b border-[var(--aethel-border-primary)] bg-[linear-gradient(180deg,var(--aethel-panel-strong),var(--aethel-surface-primary))] px-3 py-2 text-xs shadow-[inset_0_-1px_0_color-mix(in_srgb,white_3%,transparent)]">
