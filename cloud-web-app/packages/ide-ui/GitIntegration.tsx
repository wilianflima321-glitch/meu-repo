...
import { GitBranch, GitCommit, GitMerge, RefreshCw, Plus, X, Check, AlertTriangle, Clock, Upload, Download } from 'lucide-react'
...
export function GitIntegration({
  ...
  return (
    <div className="flex h-full flex-col bg-[var(--aethel-surface-primary)] relative">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[var(--aethel-border-primary)] bg-[color-mix(in_srgb,var(--aethel-surface-secondary)_70%,transparent)] px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onPull}
            className="p-1.5 rounded-lg text-[var(--aethel-text-tertiary)] hover:text-[var(--aethel-success-light)] hover:bg-[color-mix(in_srgb,var(--aethel-success)_10%,transparent)] transition-colors"
          ...
          <button
            type="button"
            onClick={onPush}
            className="p-1.5 rounded-lg text-[var(--aethel-text-tertiary)] hover:text-[var(--aethel-primary-light)] hover:bg-[color-mix(in_srgb,var(--aethel-primary)_10%,transparent)] transition-colors"
        ...
        {status?.staged && status.staged > 0 && (
          <div className="rounded-lg border border-[var(--aethel-border-secondary)] bg-[color-mix(in_srgb,var(--aethel-surface-secondary)_50%,transparent)] p-3">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-medium text-[var(--aethel-text-primary)]">Staged</span>
