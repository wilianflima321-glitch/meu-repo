...
import type { MonacoChatDiffPanelProps } from '../../web/lib/editor/MonacoChatDiffPanel.runtime'

export type { MonacoChatDiffPanelProps } from '../../web/lib/editor/MonacoChatDiffPanel.runtime'

const RuntimeMonacoChatDiffPanel = dynamic<MonacoChatDiffPanelProps>(
  () => import('../../web/lib/editor/MonacoChatDiffPanel.runtime').then((module) => module.MonacoChatDiffPanel),
  {
    ssr: false,
    loading: () => (
